 ...
 * @version 1.0
 */
public class GridRegionTest extends TestCase {
    ...
    public void testUnmapRegion(){
        ...
        assertTrue(Arrays.equals(new int []{0, 0, 0},
                new GridRegion(0, 0).unmapRegion(2)));
        assertTrue(Arrays.equals(new int []{0, 0, 0, 0},
                new GridRegion(0, 0).unmapRegion(3)));

        assertTrue(Arrays.equals(new int []{1, 0, 0},
                new GridRegion(0, 1).unmapRegion(2)));
        assertTrue(Arrays.equals(new int []{1, 1, 0},
                new GridRegion(1, 1).unmapRegion(2)));

        assertTrue(Arrays.equals(new int []{2, 1, 0},
                new GridRegion(1, 2).unmapRegion(2)));
        assertTrue(Arrays.equals(new int []{2, 1, 1},
                new GridRegion(3, 2).unmapRegion(2)));

        assertTrue(Arrays.equals(new int []{4, 1, 1},
                new GridRegion(12, 4).unmapRegion(2)));
        assertTrue(Arrays.equals(new int []{4, 1, 3},
